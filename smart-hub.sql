...
--
-- Host: localhost    Database: smart_hub_db
-- ------------------------------------------------------
...
CREATE TABLE `check_ins` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `check_ins_booking_id_foreign` (`booking_id`),
  KEY `check_ins_user_id_foreign` (`user_id`),
  CONSTRAINT `check_ins_booking_id_foreign` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `equipment` (
  ...
  CONSTRAINT `equipment_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2026-07-18 10:42:09
